...
# Knowledge Base
known = And(
    # character A can be either Knight or Knave, but not both (repeat for B and C)
    Or(AKnight, AKnave),
    Or(BKnight, BKnave),
    Or(CKnight, CKnave),
...
knowledge0 = And(
    known,
    # if A is a knight, then the statement made is true
    Implication(AKnight, And(AKnight, AKnave)),
    # if A is knave, then the statement made is false
...
knowledge1 = And(
    ...
    # if A is a knave, then both cannot be a knave
